...
class TestPatron(unittest.TestCase):
    ...
    def test_eq_equal(self):
        test_patron = patron("fname", "lname", "15", "1")
        equal_patron = patron("fname", "lname", "15", "1")
        result = test_patron.__eq__(equal_patron)
        self.assertEqual(True, result)

    def test_eq_not_equal(self):
        test_patron = patron("fname", "lname", "15", "1")
        not_equal_patron = patron("fnamedifferent", "lnamedifferent", "21", "1")
        result = test_patron.__eq__(not_equal_patron)
        self.assertEqual(False, result)

    def test_ne_equal(self):
        test_patron = patron("fname", "lname", "15", "1")
        test_equal = patron("fname", "lname", "15", "1")
        result = test_patron.__ne__(test_equal)
        self.assertEqual(False, result)

    def test_ne_not_equal(self):
        test_patron = patron("fname", "lname", "15", "1")
        test_not_equal = patron("fnamedifferent", "lnamedifferent", "15", "1")
